...
class Interpreter:
    ...
    def store_variable(self, var_name, value, data_type):
        self.variables[var_name] = (data_type, value)
    ...
    def handle_command(self, command):
        ...
        command_mapping = {
            ...
            'easteregg': self.cmd_easteregg,
            'adv': self.adv_easteregg
            }
    ...
    def cmd_reg(self, args):
        ...
        if data_type == "int":
            ...
            self.cmd_log("Invalid data type")
    ...
    def cmd_easteregg(self, args):
        self.cmd_log("hi")
    def adv_easteregg(self, args):
        self.cmd_log("https://advstudios.xyz/")    
...
if __name__ == "__main__":
    ...
    while True:
        restart = input("Enter R to restart program or any other key to exit: ")
        if restart.lower() == 'r':
            interpreter = Interpreter(debug=args.debug)
            interpreter.run()
        else:
